...
func init() {
	proto.RegisterType((*MsgCreatePost)(nil), "chen7gx.blog.blog.MsgCreatePost")
	proto.RegisterType((*MsgCreatePostResponse)(nil), "chen7gx.blog.blog.MsgCreatePostResponse")
	proto.RegisterType((*MsgUpdatePost)(nil), "chen7gx.blog.blog.MsgUpdatePost")
	proto.RegisterType((*MsgUpdatePostResponse)(nil), "chen7gx.blog.blog.MsgUpdatePostResponse")
	proto.RegisterType((*MsgDeletePost)(nil), "chen7gx.blog.blog.MsgDeletePost")
	proto.RegisterType((*MsgDeletePostResponse)(nil), "chen7gx.blog.blog.MsgDeletePostResponse")
}
...
var fileDescriptor_90382f40c04acbba = []byte{
	...
	0xd7, 0x2f, 0xa9, 0xd0, 0x2b, 0x28, 0xca, 0x2f, 0xc9, 0x17, 0x12, 0x4c, 0xce, 0x48, 0xcd, 0x33,
	0x4f, 0xaf, 0xd0, 0x03, 0x09, 0x83, 0x09, 0xa5, 0x60, 0x2e, 0x5e, 0xdf, 0xe2, 0x74, 0xe7, 0xa2,
	...
	0x29, 0x4a, 0xc9, 0x60, 0xdb, 0x43, 0x0b, 0x52, 0x08, 0xdb, 0x0e, 0xd1, 0xca, 0x04, 0xd3, 0x8a,
	0x70, 0x0d, 0x33, 0x36, 0xd7, 0xb0, 0x20, 0xb9, 0x46, 0x1c, 0xec, 0x1a, 0x84, 0x25, 0x30, 0xd7,
	0x28, 0x59, 0x82, 0x6d, 0x77, 0x49, 0xcd, 0x49, 0x25, 0xd5, 0x76, 0xa8, 0x99, 0x08, 0xad, 0x30,
	0x33, 0x8d, 0x26, 0x33, 0x71, 0x31, 0xfb, 0x16, 0xa7, 0x0b, 0x45, 0x70, 0x71, 0x21, 0x05, 0xaa,
	0x82, 0x1e, 0x46, 0xc8, 0xeb, 0xa1, 0x84, 0x90, 0x94, 0x06, 0x21, 0x15, 0xf0, 0x30, 0x8c, 0xe0,
	0xe2, 0x42, 0x0a, 0x30, 0x1c, 0x26, 0x23, 0x54, 0xe0, 0x32, 0x19, 0x33, 0x3c, 0x40, 0x26, 0x23,
	0x05, 0x06, 0x0e, 0x93, 0x11, 0x2a, 0x70, 0x99, 0x8c, 0x19, 0x2a, 0x4e, 0x76, 0x27, 0x1e, 0xc9,
	...
	0x9c, 0x9f, 0xab, 0x0f, 0x35, 0x4d, 0x1f, 0x9c, 0x68, 0xa1, 0x54, 0x49, 0x65, 0x41, 0x6a, 0x71,
	0x12, 0x1b, 0x38, 0xfd, 0x1a, 0x03, 0x02, 0x00, 0x00, 0xff, 0xff, 0x2c, 0x8d, 0x1f, 0xce, 0xd0,
	0x02, 0x00, 0x00,
}
...
func (c *msgClient) CreatePost(ctx context.Context, in *MsgCreatePost, opts ...grpc.CallOption) (*MsgCreatePostResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/chen7gx.blog.blog.Msg/CreatePost", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) UpdatePost(ctx context.Context, in *MsgUpdatePost, opts ...grpc.CallOption) (*MsgUpdatePostResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/chen7gx.blog.blog.Msg/UpdatePost", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) DeletePost(ctx context.Context, in *MsgDeletePost, opts ...grpc.CallOption) (*MsgDeletePostResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/chen7gx.blog.blog.Msg/DeletePost", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_CreatePost_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/chen7gx.blog.blog.Msg/CreatePost",
	}
...
func _Msg_UpdatePost_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/chen7gx.blog.blog.Msg/UpdatePost",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Msg_DeletePost_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/chen7gx.blog.blog.Msg/DeletePost",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "chen7gx.blog.blog.Msg",
